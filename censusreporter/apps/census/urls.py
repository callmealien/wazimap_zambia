...
from .wazi import (GeographyDetailView, GeographyJsonView, PlaceSearchJson, LocateView,
                   DataAPIView, TableAPIView)
...
urlpatterns = patterns('',
    ...
    # e.g. /profiles/province-702/
    url(
        regex   = '^profiles/(?P<geography_id>(%s)-[\w]+)(-(?P<slug>[\w-]+))?/$' % geo_levels,
